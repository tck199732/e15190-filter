...
bool hira::PassAngularCut(const double &theta_deg, const double &phi_deg)
{
    return (
...
bool hira::PassKinergyCut(const std::string &particle_name, const double &kinergy_per_nucleon)
{
